...
// given level register themselves properly with the corresponding level and un-register
// themselves when they don't anymore.
...
python API
    ...
    make_dual
    unpack_dual
update set_fw_grad in variable.cpp
    new view behavior (dont change parent)
